                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildChannelStatus(
                              ...
                              value: (security?['user']?['authProvider'] == 'GOOGLE' || security?['security']?['authProvider'] == 'GOOGLE') ? 'Đã liên kết' : 'Chưa liên kết',
                              isVerified: security?['user']?['authProvider'] == 'GOOGLE' || security?['security']?['authProvider'] == 'GOOGLE',
                              hasChannel: security?['user']?['authProvider'] == 'GOOGLE' || security?['security']?['authProvider'] == 'GOOGLE',
