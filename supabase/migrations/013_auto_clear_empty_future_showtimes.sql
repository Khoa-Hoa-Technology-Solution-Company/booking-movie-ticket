-- =========================================================================
-- AUTO CLEAR EMPTY FUTURE SHOWTIMES BEFORE REGENERATION
-- =========================================================================
...
BEGIN
  ...
  -- 2. Tự động xóa các suất chiếu trong tương lai mà chưa có ai đặt vé (tránh xung đột lịch cũ)
  -- Điều này giúp phim mới chuyển từ sắp chiếu sang đang chiếu lập tức có suất chiếu
  ...
  FOR v_day_offset IN 0..(p_days_count - 1) LOOP
    ...
    FOR v_room IN SELECT * FROM rooms LOOP
      ...
      FOREACH v_time IN ARRAY v_times LOOP
        ...
        -- (Thường chỉ trùng nếu suất chiếu đó có người đặt vé và không bị xóa ở bước 2)
        IF NOT EXISTS (
